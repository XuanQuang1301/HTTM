...
| :---: | :--- | :--- | :--- | :---: |
| **01** | **Scream / Cry for help** | Tiếng la hét, tiếng người kêu cứu, bạo lực | • Kích hoạt còi hú tại chỗ<br>• Gửi thông báo khẩn SOS đến ban quản lý và cơ quan chức năng | **Khẩn cấp** |
...
- Đảm nhận việc đọc dữ liệu âm thanh theo từng cửa sổ thời gian (cửa sổ 1 giây hoặc 2 giây với độ chồng lấp 50%).
...
- **Công nghệ Backend & Giao diện:** Python Flask / FastAPI, HTML5/CSS3.
...
- Hoàn thành thiết kế kiến trúc hệ thống 4 khối chức năng đảm bảo tính logic và tính khảthi của một hệ thống thông minh.
